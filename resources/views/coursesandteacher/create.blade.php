    ...
    <main>
        ...
        <div class="row g-2">
            <div class="col-md-5 col-lg-8">
                <h4 class="mb-1">Courses and teachers Information</h4>

                <form method="POST" action="{{ route('coursesandteachers.store') }}"  role="form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <input href="{{url('home')}}" class="btn btn-primary mb-5" type="submit" value="Save">
