                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                             ...
                             <div class="float-right">
                                <a href="{{ route('coursesandteachers.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Create New') }}
                                </a>
                              </div>
                                ...
                                <tbody>
                                    @foreach ($coursesandteachers as $coursesandteacher)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('coursesandteachers.destroy',$coursesandteacher->id) }}" method="POST">
                                                   <!-- <a class="btn btn-sm btn-primary " href="{{ route('coursesandteachers.show',$coursesandteacher->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>-->
                                                    <a class="btn btn-sm btn-success" href="{{ route('coursesandteachers.edit',$coursesandteacher->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
